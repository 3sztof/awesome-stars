...
- [msdanyg/smart-connections-mcp](https://github.com/msdanyg/smart-connections-mcp) - MCP server for semantic search and knowledge graphs in Obsidian vaults using Smart Connections embeddings
