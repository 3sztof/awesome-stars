...
- [aws-samples/amazon-transcribe-live-meeting-assistant](https://github.com/aws-samples/amazon-transcribe-live-meeting-assistant) - Live Meeting Assistant (LMA) - AI-powered live meeting transcription, translation, summarization, and assistant using Amazon Transcribe, Amazon Bedrock, and other AWS AI services
...
- [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) - omo/lazycodex: The coding agent for tokenmaxxers;the one and only agent harness for complex codebases. For your Codex, for your OpenCode
- [msdanyg/smart-connections-mcp](https://github.com/msdanyg/smart-connections-mcp) - Give Claude semantic memory of your Obsidian vault — local semantic search over Smart Connections embeddings via MCP. Multi-vault, block-level, 100% private.
...
- [stemrollerapp/stemroller](https://github.com/stemrollerapp/stemroller) - Isolate vocals, drums, bass, and other instrumental stems from any song
- [vladimiry/ElectronMail](https://github.com/vladimiry/ElectronMail) - Unofficial ProtonMail Desktop App
- [konradmichalik/temps](https://github.com/konradmichalik/temps) - Simple menubar application based on Electron with actual weather information and forecast.
...
- [usetrmnl/larapaper](https://github.com/usetrmnl/larapaper) - A self-hosted, community-driven server (BYOS) with Recipe support in PHP's Laravel framework
- [BookStackApp/BookStack](https://github.com/BookStackApp/BookStack) - NOW MANAGED ON CODEBERG
...
- [akshin18/monitor_man](https://github.com/akshin18/monitor_man) - 
- [aws-samples/sample-amazon-quick-suite-knowledge-hub](https://github.com/aws-samples/sample-amazon-quick-suite-knowledge-hub) - This repository provides detail setup guides, samples, and integration documentation for Amazon Quick, helping you with your Quick experience.
...
- [bartekbrak/oggle](https://github.com/bartekbrak/oggle) - 
- [usetrmnl/plugins](https://github.com/usetrmnl/plugins) - e-ink dashboard plugin logic
...
- [aws-samples/sample-host-openclaw-on-amazon-bedrock-agentcore](https://github.com/aws-samples/sample-host-openclaw-on-amazon-bedrock-agentcore) - 
...
- [Builty/TonexOneController](https://github.com/Builty/TonexOneController) - Embedded controller for the IK Multimedia Tonex One, Tonex Pedal, and Valeton GP5 guitar pedals
...
- [aws-samples/responsible_ai_reduce_hallucinations_for_genai_apps](https://github.com/aws-samples/responsible_ai_reduce_hallucinations_for_genai_apps) - Python labs demonstrating various techniques for reducing hallucinations in apps using large language models
...
- [maciejjedrzejczyk/tldr](https://github.com/maciejjedrzejczyk/tldr) - Apple Shortcuts Integration with Ollama via a summarizer app
...
- [rdiers/AmazonLinux-2-CIS](https://github.com/rdiers/AmazonLinux-2-CIS) - Ansible Amazon Linux 2 - CIS Benchmark Hardening Script
...
- [Shubhamsaboo/awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps) - 100+ AI Agents, Agent Skills and RAG Apps - Free and Open Source.
- [gradio-app/gradio](https://github.com/gradio-app/gradio) - Build and share delightful machine learning apps, all in Python. 🌟 Star to support our work!
- [BotoX/xiaomi-m365-firmware-patcher](https://github.com/BotoX/xiaomi-m365-firmware-patcher) - Automatize patching of Xiaomi Mijia M365 electric scooter firmware
- [bregman-arie/devops-exercises](https://github.com/bregman-arie/devops-exercises) - Linux, Jenkins, AWS, SRE, Prometheus, Docker, Python, Ansible, Git, Kubernetes, Terraform, OpenStack, SQL, NoSQL, Azure, GCP, DNS, Elastic, Network, Virtualization. DevOps Interview Questions
- [nicotine-plus/nicotine-plus](https://github.com/nicotine-plus/nicotine-plus) - Graphical client for the Soulseek peer-to-peer network
- [home-assistant/core](https://github.com/home-assistant/core) - :house_with_garden: Open source home automation that puts local control and privacy first.
